...
const LANGUAGE_ID = 'kamailio-cfg';
const METHOD = 'kamailio/analysisRoot';
...
class LanguageClient {
    ...
    async sendRequest(method, params) {
        ...
        return params.uri.includes('/inc/') ? 'file:///w/kamailio.cfg' : null;
    }
...
(async () => {
    ...
    // Kamailio tree usually names them `.inc`. The extension test
