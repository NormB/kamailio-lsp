...
| A huge folder: includes stop being recognised | The scan behind this stops at 500 `.cfg` files and says so in **View → Output → Kamailio LSP**. Open a folder closer to your configuration instead of the whole tree. |
