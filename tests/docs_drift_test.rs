...
/// initialization options, `KAMAILIO_LSP_*` environment fallbacks,
...
/// fresh user reads.
///
/// The vendored core catalogue shipped in 0.13.0 and was described in
/// `docs/FEATURES.md` and the marketplace listing, while `README.md`
/// still presented `kamailioWiki` as the only way to get documentation
